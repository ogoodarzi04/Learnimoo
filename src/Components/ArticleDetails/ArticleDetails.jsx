...
export default function ArticleDetails() {
   ...
   //
   return (
      <div className="ArticleDetails bg-header-color rounded-2xl p-4 sm:p-5 text-white">
         {/* <!-- head --> */}
         <div className=" flex items-center gap-x-2 mb-5 sm:mb-6 pb-5 sm:pb-6  relative mt-7" style={{ borderBottom: "1px solid #ffffff1a" }}>
            <span className="absolute -right-6 sm:-right-[21px] block w-2.5 h-[34px] md:h-9.5 bg-blue-500 rounded-r-sm"></span>
            <h1 className=" danaDemiBold text-xl md:text-[26px]/10 text-white ms-2.5">فرق بک اند و فرانت اند چیست</h1>
         </div>
         {/* <!-- info --> */}
         ...
         <div>
            ...
            <div className="rounded-lg !rounded-tr-none  mt-8 overflow-hidden mb-6 md:mb-8" id="toc-collapse" style={{ border: "1px solid rgb(100 116 139)" }}>
               <div className="flex items-center justify-between px-4 py-[20px] " style={{ borderBottom: "1px solid rgb(100 116 139)" }}>
                  <div className="flex items-center gap-x-3.5">
                  ...
                  <button
                     ...
                     className=" flex   p-1.5 rounded-full my-auto"
               ...
               {showHeadlines ? (
                  <div className="flex flex-col gap-4  p-5 text-sm md:!text-[16.5px] ">
                     <a href="#h_1" className=" danaDemiBold text-white">
                        <span>بک اند و فرانت اند چیست؟</span>
                     </a>
                     <a href="#h_2" className=" danaDemiBold text-white">
                        <span>فرق بک اند و فرانت اند چیست</span>
                     </a>
                     <a href="#h_3" className=" danaDemiBold text-white">
                        <span>زبان‌ های برنامه‌ نویسی بک اند و فرانت اند</span>
                     </a>
                     <a href="#h_4" className=" danaDemiBold text-white">
                        <span>درآمد برنامه نویسی بک اند بالاتر است یا فرانت اند؟</span>
                     </a>
                     <a href="#h_5" className=" danaDemiBold text-white">
            ...
            <div className="wp-content danaDemiBold space-y-10">
               <div className=" mt-5 mb-14 danaDemiBold">
                  <p className=" text-gray-color">
                     <strong className=" text-white">بک اند و فرانت اند</strong> پایه و اساس تمام سایت‌هایی است که امروزه مشاهده می‌کنید؛ یک سایت بدون این 2 بخش وجود نخواهد داشت و شما نمیتوانید سایت
                     را فقط با فرانت یا فقط بک اند خالی طراحی کنید. می‌پرسید چرا؟ در ادامه این مقاله از
               ...
               <p className=" text-gray-color">برنامه‌نویسان فرانت‌اند همچنین باید با مفاهیم طراحی رابط کاربری (UI) و تجربه کاربری (UX) آشنا باشند تا بتوانند رابط کاربری مناسبی را پیاده‌سازی کنند.</p>
               <p className=" text-gray-color">پس تا اینجا متوجه شدیم که فرانت اند چیست و در ادامه نیز به مفهوم بک اند می‌پردازیم.</p>
               ...
               <p className=" text-gray-color">خب مشخص است به دلیل ضعف آن نیست بلکه به این دلیل است که برای این کار ساخته نشده!!</p>
               <p className=" text-gray-color">بک اند برای کنترل دستورات و برنامه ریزی کدها و عملکرد یک سایت طراحی شده و بیشتر جنبه مدیریتی داره تا ظاهر سازی و…</p>
               <p className=" text-gray-color">
               ...
               <p className=" text-gray-color">البته میتوانید هر دو را نیز انتخاب کنید اما کارتان را کمی سخت می‌کند…</p>
               <p className=" text-gray-color">
                  <img
                     decoding="async"
                     loading="lazy"
               ...
               <p className=" text-gray-color">
                  <span style={{ fontSize: "13pt" }}>
                     <strong className=" text-white  danaBold">
                        پیشنهاد مطالعه:
                        <a href="" className=" text-blue-500">
               ...
               <p className=" text-gray-color">در ادامه به زبان‌ها و فریمورک هایی که برای بک اند به آن‌ها نیاز دارید می‌پردازیم:</p>
               <ul>
                  <li>PHP</li>
                  <li>Python</li>
                  <li>Java</li>
               ...
               <p className=" text-gray-color">
                  هرگونه سوال تخصصی‌تر در رابطه با مسیر <strong className=" text-white  danaBold">بک اند و فرانت اند</strong> داشتید می‌تونید در بخش کامنت های همین مقاله بپرسید تا افراد متخصص شما را
                  راهنمایی کنند.
               </p>
               <p className=" text-gray-color">
                  <img
               ...
               <p className=" text-gray-color">پس اگر عاشق چالش و سختی هستید بک اند می‌تواند هدف خوبی برای شما باشد و اگر دنبال مسیر ساده هستید فرانت اند بدون شک قدم بعدی شماست.</p>
               <h3 className=" text-3xl danaBold">نتیجه گیری</h3>
               <p className=" text-gray-color">
                  در این مقاله <strong className=" text-white danaBold">بک اند و فرانت اند</strong> را به طور کامل به شما توضیح دادیم و کارایی و درجه سختی و میزان درآمد آن‌ها را نیز به طور کامل
                  فهمیدیم؛ با این اطلاعات احتمالا بتوانید انتخاب مناسبی داشته باشید. هرگونه سوال و یا ابهامی هم اگر داشتید در بخش کامنت ها بپرسید.
               </p>
            </div>
         </div>
      </div>
