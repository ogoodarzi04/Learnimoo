            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-[20px] ">
               <div className="flex items-center gap-x-4 headlinecourse p-4 rounded-xl dark:!bg-light-theme-color">
                  ...
                  <div className=" space-y-8">
                     <a href="https://sabzlearn.ir/blog/best-programming-language-for-migration/" className="danaMedium line-clamp-1 text-white dark:!text-black">
               ...
               <div className="flex items-center gap-x-4 headlinecourse p-4 rounded-xl dark:!bg-light-theme-color ">
                  ...
                  <div className=" space-y-8 ">
                     <a
                        href="https://sabzlearn.ir/blog/%d8%ae%d8%b7%d8%b1%d8%a7%d8%aa-%d9%87%d9%88%d8%b4-%d9%85%d8%b5%d9%86%d9%88%d8%b9%db%8c/"
                        className="danaMedium line-clamp-1 text-white dark:!text-black"
                     >
                        خطرات هوش مصنوعی
                     </a>
