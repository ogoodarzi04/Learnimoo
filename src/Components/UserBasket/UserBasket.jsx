                  ...
                  >
                     ...
                     <Card className="w-[340px] pb-8 rounded-[12px] bg-header-color dark:bg-white dark:!text-black">
                                    ...
                                    <div>
                                       <div className="cart-item flex items-center gap-x-3 text-white dark:!text-black">
                                          <Link to={`http://localhost:5173/course-info/${item?.shortName}`} className="shrink-0 text-white dark:!text-black">
                                             <img className=" h-24 aspect-video rounded-lg" src={`http://localhost:3000/courses/covers/${item?.cover}`} alt={item?.name} />
                                          </Link>
                        ...
                        <div className="mt-3 px-[14.5px] dark:!border-t-[#e5e7eb]" style={{ borderTop: "1px solid #ffffff1a" }}>
                           ...
                           <Link to={"http://localhost:5173/cart"} className="w-full text-white dark:!text-black">
