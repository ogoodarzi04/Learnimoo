                                 ...
                                 <div className="cart-item items-center gap-x-3 pb-[18px] grid md:grid-cols-2">
                                    <div className=" relative">
                                       ...
                                       <Link to={`/course-info/${item?.shortName}`} className="shrink-0 flex text-white dark:!text-black">
                                          <img className=" md:h-36 aspect-video rounded-[15px] md:rounded-[8px]" src={`https://learnimo.liara.run/courses/covers/${item?.cover}`} alt={item?.name} />
                                          ...
                                          <div className="flex  gap-x-[63px] dark:text-limon-color text-limon-color">
                                             {item?.price === 0 ? (
                                                ...
                                                <span className="danaMedium text-[17px] flex">
                                                   ...
                                                   <img className=" size-8 flex !text-white" src="https://learnimo.liara.run/courses/covers/Toman.png" alt="" />
                                                </span>
                                             )}
                                             <HiOutlineTrash
                                                // onClick={(e) => DeleteCourse(item._id)}
               ...
               <div className="relative flex flex-col h-21 lg:h-auto lg:w-1/2">
                  ...
                  <div className="upselling-step upselling-step--active " style={{ right: "0%" }}>
                     <div className="upselling-step__price flex ">
                        ...
                        <img className=" size-8 flex " src="https://learnimo.liara.run/courses/covers/Toman.png" alt="" />
                     </div>
