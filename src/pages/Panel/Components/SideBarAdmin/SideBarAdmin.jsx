...
export default function SideBarAdmin(props) {
   ...
   return (
      <div className={`SideBar bg-[#111219]   w-full !text-gray-400 dark:text-black`} style={{ borderLeft: !props.hiddenStyle ? "2px solid #323232" : "" }}>
         <div className="SideBar-title   ">
            <div className="logo-footer md:ps-14 py-[40px] flex gap-x-5">
               <div className="logo-img ">
                  <img src="/images/slazzer-edit-image (2)_prev_ui.png" alt="" className=" md:h-[35px] md:w-[55px] h-[38px] w-[120px] " />
               </div>
               <div className=" my-auto">
                  <p className=" text-gray-200 danaMedium md:text-[25px] text-[27px] dark:!text-blue-gray-900 ">لرنیمو</p>
               </div>
               {props.hiddenStyle}
            </div>
         </div>
