...
export default function NotifiCation(props) {
   ...
   function confirmNotif(item) {
      ...
      // if (notif) {
      editedata(`http://localhost:3000/v1/notifications/see/${notif?._id}`, userDatas.token);
      // }
   }
   ...
   return (
      <>
         <div className="NotifiCation ">
            <Menu>
               <MenuHandler>
                  <IconButton variant="text">{props.children}</IconButton>
               </MenuHandler>
               <MenuList className="flex flex-col gap-2 cursor-pointer">
                  {
                     props?.notifs?.length > 0
                        ? props?.notifs?.map((item) => {
                             return (
                                <MenuItem
                                ...
                                >
                                   <Avatar variant="circular" alt="tania andrew" src="/images/amir.jpg" />
                     ...
                     //    <Avatar variant="circular" alt="natali craig" src="/images/amir.jpg" />
                     //    <div className="flex flex-col gap-1">
                     //       <Typography variant="small" color="gray" className="font-semibold">
